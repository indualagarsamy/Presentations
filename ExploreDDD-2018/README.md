...
This folder contains both the Keynote presentation file and a PDF version of the same presentation. 

* [Keynote File](https://github.com/indualagarsamy/Presentations/blob/master/ExploreDDD-2018/Changing%20Requirements.key)


* [PDF](https://github.com/indualagarsamy/Presentations/blob/master/ExploreDDD-2018/Changing%20Requirements.pdf)
...
The [BeforeTimeouts](https://github.com/indualagarsamy/Presentations/tree/master/ExploreDDD-2018/BeforeTimeouts) folder contains an example of a Saga that does not use timeouts.  

### Second Implementation

The [CompleteSolutionWithTimeouts](https://github.com/indualagarsamy/Presentations/tree/master/ExploreDDD-2018/CompleteSolutionWithTimeouts) folder contains an example of a Saga that uses timeouts.
